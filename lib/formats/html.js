    ...
    return `
      ...
      <html lang="en">
        ...
        <body>
          ...
          <div class="container">
            <main role="main">
              ${this.renderSection("theme-color", "Theme Colors")}
              ...
              ${this.renderSection("time", "Time", this.renderMisc)}
              ${this.renderSection("media-query", "Media Queries")}
              ${this.renderSection("misc", "Miscellaneous", this.renderMisc)}              
            </main>
          </div>
        </body>
      </html>
